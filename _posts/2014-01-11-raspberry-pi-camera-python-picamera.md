...
For my [raspberry pi car cam project](/posts/raspberry-pi-car-cam-overlaid-with-obd/) I needed to find a better way of [syncing data with video](/posts/raspberry-pi-syncing-data-with-raspivid/) so I modified [raspivid](/posts/raspberry-pi-syncing-data-with-raspivid/) and created [python class to run raspivid](/posts/raspberry-pi-run-raspivid-with-python/). I did this hack mainly because I couldn't be bothered and didn't really have the skill to write an interface to the camera in python, luckily someone else has!
