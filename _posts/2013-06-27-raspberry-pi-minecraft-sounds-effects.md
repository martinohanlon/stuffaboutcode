---
title: 'Raspberry Pi - Minecraft - Sounds Effects'
date: 2013-06-27 20:47:00 +01:00
tags: [minecraft, python, raspberry-pi]
redirect_from:
  - /2013/06/raspberry-pi-minecraft-sounds-effects.html
---

I got bored with Minecraft on the Raspberry Pi not having any sound so I decided to make my own!

{% include youtube.html id="4oSzoJ9OHWI" %}

I grabbed some sound effects off [http://soundbible.com](http://soundbible.com/) and set about making a program which would monitor what Minecraft Steve was doing and play an appropriate sound effect, e.g if Steve's walking I would play the sound of footsteps, if he jumped I would play a 'boing' and my favourite if he fell off a cliff you would hear him scream before hitting the ground.

![](/assets/img/2013/06/minecraft-soundeffects.png)
...
You can download the code direct from [github](https://github.com/martinohanlon/minecraft-sound), [https://github.com/martinohanlon/minecraft-sound](https://github.com/martinohanlon/minecraft-sound), so run minecraft, open/create a world and follow the instructions:
