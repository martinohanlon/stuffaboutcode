---
title: 'Minecraft Coding a Traffic Jam'
date: 2013-11-03 20:11:00 +00:00
tags: [minecraft, python, raspberry-pi]
redirect_from:
  - /2013/11/minecraft-coding-traffic-jam.html
---
...
{% include youtube.html id="AvSe-20e0_U" %}

My finished traffic jam.

I created 5 programs to show how I went from creating 1 traffic light to my traffic jam. Each program led on from the next. All the code is on [github](http://github.com/), [https://github.com/martinohanlon/minecraft-traffic](https://github.com/martinohanlon/minecraft-traffic).

[1light.py](http://1light.py/) - is a really basic implementation of a traffic light, a single function which sets the blocks in turn.

![](/assets/img/2013/11/2013-10-27_20.47.59_crop.png)
...
[1light-functions.py](https://github.com/martinohanlon/minecraft-traffic/blob/master/1light-functions.py) - is effectively the same program as 1light.py, but I have split the code into 3 functions:
...
[2lights.py](https://github.com/martinohanlon/minecraft-traffic/blob/master/2lights.py) - creates 2 traffic lights, which work in unison, one setting to stop, the other setting to go. To do this I created a class called TrafficLight. The main program then created 2 instances of this class and called stop, go methods of the class to change the lights

![](/assets/img/2013/11/2013-10-27_20.50.30_crop.png)
