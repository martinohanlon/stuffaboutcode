---
title: 'Raspberry Pi - Minecraft - Planetary Gravity Sim'
date: 2013-03-07 21:32:00 +00:00
...
{% include youtube.html id="o71zGMZ3GkI" %}
...
**Download and run**
 You can download the code direct from [git-hub](https://github.com/martinohanlon/minecraft-planets.git), so run minecraft, open/create a world and follow the instructions:
...
***Code***
[https://github.com/martinohanlon/minecraft-planets.git](https://github.com/martinohanlon/minecraft-planets.git)
